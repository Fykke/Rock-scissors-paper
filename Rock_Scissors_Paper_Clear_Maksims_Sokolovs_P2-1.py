...
rpc_rock = Button(rpc, text='Rock', font='Helvetica 14 bold', bg='#837B71', width=7, borderwidth=5, command=rock)
rpc_scissors = Button(rpc, text='Scissors', font='Helvetica 14 bold', bg='#56768B', width=8, borderwidth=5, command=scissors)
rpc_paper = Button(rpc, text='Paper', font='Helvetica 14 bold', bg='#C2C9CE', width=7, borderwidth=5, command=paper)
rpc_restart = Button(rpc, text='Play Again!', font='Helvetica 14 bold', bg='#1b4f72', width=7, borderwidth=5, command=restart)
...
rpc_won = Label(rpc, width=8, bg='#7fb3d5', textvariable=won_var, font='Helvetica 10 bold', padx=5, pady=5, borderwidth=3) #raunda uzvarētājs
rpc_who_won = Label(rpc, width=10, bg='#7fb3d5', textvariable=winner, font='Helvetica 10 bold', padx=5, pady=5, borderwidth=5) #spēlēs uzvarētājs
